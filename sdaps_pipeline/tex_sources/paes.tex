...
%   colsep=5pt  — horizontal space between columns. Kept at the original 5pt
%                 (rather than panasSF's 10pt) because the row labels here are
%                 full sentences and need the header column to stay wide
%                 enough for the 1cm shift below.
...
\begin{optiongroup}[colsep=5pt, rowsep=10pt]{}
    ...
    %   2.2cm width (slightly wider than the original 2cm) so that columns
    %   are equal regardless of label length and "Neither agree nor disagree"
    %   wraps more cleanly.
    ...
    \choice[val=1]{\parbox[t]{2.2cm}{\centering Strongly disagree}}
    \choice[val=2]{\parbox[t]{2.2cm}{\centering Disagree}}
    \choice[val=3]{\parbox[t]{2.2cm}{\centering Neither agree nor disagree}}
    \choice[val=4]{\parbox[t]{2.2cm}{\centering Agree}}
    \choice[val=5]{\parbox[t]{2.2cm}{\centering Strongly agree}}
    ...
    % \makebox[\hsize][r]{...\hspace*{1cm}} keeps the label right-aligned
    %   (as before) but shifts it 1cm to the left, away from the response
    %   circles, instead of moving it flush to the left margin.
    \question[var=paes001]{\makebox[\hsize][r]{I enjoy it\hspace*{1cm}}}
    \question[var=paes002]{\makebox[\hsize][r]{I find it pleasurable\hspace*{1cm}}}
    \question[var=paes003]{\makebox[\hsize][r]{It is very pleasant\hspace*{1cm}}}
    \question[var=paes004]{\makebox[\hsize][r]{It feels good\hspace*{1cm}}}
\end{optiongroup}
\end{questionnaire}
\end{document}
